...
# convert slide to factor as well
...
mixedOutmc <- mixedModelDE(target_demoData,
                           ...
                           multiCore = FALSE,
                           pAdjust = 'fdr')
results2 <- do.call(rbind, mixedOutmc['lsmeans', ])
tests <- rownames(results2)
results2 <- as.data.frame(results2)
results2$Test <- tests
rownames(results2) <- names(mixedOutmc['lsmeans', ])
results2$Gene <- names(mixedOutmc['lsmeans', ])
```
