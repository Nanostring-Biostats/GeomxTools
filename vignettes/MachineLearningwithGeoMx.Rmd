...
```{r echo = FALSE, fig.cap = "Naive Bayes"}
library(knitr)
...
```{r echo = FALSE, fig.cap = "K-Nearest Neighbor"}
...
##### h. Probability of Skipping Drop-out (skip-drop)
##### i. Minimum Sum of Instance Weight (min_child_weight)

```{r echo = FALSE, fig.cap = "XGBoost"}
...
```{r echo = FALSE, fig.cap = "Random Forest"}
...
```{r echo = FALSE, fig.cap = "Support Vector Machine"}
