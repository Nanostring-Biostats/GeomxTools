...
tyrosineHydroxylase <- which(proteinOrder == "Tyrosine Hydroxylase")

fig()
rect(xleft = 3.5, xright = tyrosineHydroxylase, ybottom = -6, ytop = 10, density = 2, col = "red", lty = 3)

#Right most protein where all proteins to the left will get removed
#start at 4 to keep the 3 IgG targets
proteinOrder <- proteinOrder[-c(4:tyrosineHydroxylase)]
length(proteinOrder)
